...
public class Demo4 {
    public static void main(String[] args) {
        ...
        TreeMap<String,Double> groceriesList3= new TreeMap<>();
        groceriesList3.putAll(groceriesList1);
        groceriesList3.putAll(groceriesList2);
        System.out.println(groceriesList3);
    }
}
