...
class Car extends Insurance{
    ...
    public void cancelInsurance() {
        System.out.println("Cancels the insurance for car model: "+carModel+" from "+insuranceName);
...
class Pet extends Insurance{
    ...
    @Override
    public void getQuote() {
        System.out.println("Gets a quote for pet type "+petType+" from "+insuranceName);

    }

    @Override
    public void cancelInsurance() {
        System.out.println("Cancels the insurance for pet type: "+petType+" from "+insuranceName);
...
class Health extends Insurance{
    ...
    public void getQuote() {
        ...
        System.out.println("Get quote from "+insuranceName);
